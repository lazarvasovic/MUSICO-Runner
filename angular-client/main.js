...
var map = {
	"./views/base/base.module": [
		...
		"default~views-base-base-module~views-calculations-calculations-module",
		"common",
		"views-base-base-module"
	],
	...
	"./views/calculations/calculations.module": [
		"./src/app/views/calculations/calculations.module.ts",
		"default~views-calculations-calculations-module~views-notifications-notifications-module",
		"default~views-calculations-calculations-module~views-dashboard-dashboard-module",
		"default~views-base-base-module~views-calculations-calculations-module",
		"common",
		"views-calculations-calculations-module"
	],
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'calculations',
                loadChildren: './views/calculations/calculations.module#CalculationsModule'
            }
        ]
    },
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (userData) {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].endPoint + '/users/authenticate';
        return this.http.post(url, userData);
    };
    LoginService.prototype.logout = function (message, success) {
        localStorage.removeItem('username');
        localStorage.removeItem('token');
        this.router.navigate(['/login', { message: message, success: success }]);
    };
...
module.exports = "<div class=\"app-body\">\n  <main class=\"main d-flex align-items-center\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col-md-8 mx-auto\">\n          <div class=\"card-group\">\n            <div class=\"card p-4\">\n              <div class=\"card-body\">\n                <form (submit)=\"login()\">\n                  <h1>Login</h1>\n                  <p class=\"text-muted\">Sign In to your account</p>\n                  <div class=\"input-group mb-3\">\n                    <div class=\"input-group-prepend\">\n                      <span class=\"input-group-text\"><i class=\"icon-user\"></i></span>\n                    </div>\n                    <input type=\"text\" name=\"username\" [(ngModel)]=\"username\" class=\"form-control\" placeholder=\"Username\" autocomplete=\"username\" required>\n                  </div>\n                  <div class=\"input-group mb-4\">\n                    <div class=\"input-group-prepend\">\n                      <span class=\"input-group-text\"><i class=\"icon-lock\"></i></span>\n                    </div>\n                    <input type=\"password\" name=\"password\" [(ngModel)]=\"password\" class=\"form-control\" placeholder=\"Password\" autocomplete=\"current-password\" required>\n                  </div>\n                  <div class=\"row\">\n                    <div class=\"col-6\">\n                      <button type=\"submit\" class=\"btn btn-primary px-4\">Login</button>\n                    </div>\n                    <div class=\"col-6 text-right\">\n                      <button type=\"button\" class=\"btn btn-link px-0\">Forgot password?</button>\n                    </div>\n                  </div>\n                </form>\n              </div>\n            </div>\n            <div class=\"card text-white bg-primary py-5 d-md-down-none\" style=\"width:44%\">\n              <div class=\"card-body text-center\">\n                <div>\n                  <h2>Sign up</h2>\n                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>\n                  <button type=\"button\" class=\"btn btn-primary active mt-3\">Register Now!</button>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </main>\n</div>\n"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        if (this.route.snapshot.paramMap.get('message')) {
            console.log(this.route.snapshot.paramMap.get('success'));
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.loginService.login(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.router.navigate(['calculations']);
            }
            else {
                localStorage.removeItem('username');
                localStorage.removeItem('token');
...
var environment = {
    production: false,
    endPoint: 'http://medflow.bioirc.ac.rs:3000/api'
};
...
module.exports = __webpack_require__(/*! D:\MyProjects\musico-runner\coreui-free-angular-admin-template-master\src\main.ts */"./src/main.ts");
